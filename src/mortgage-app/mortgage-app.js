    ...
    color:white;
        ...
        <li><a href="[[rootPath]]{{item.route}}">{{item.label}}</a></li>
              ...
              <iron-pages selected="[[page]]" attr-for-selected="name" role="main" fallback-selection="error404">
                <mortgage-info id="mortgage" name="mortgage"></mortgage-info>
                <transaction-details id="transaction" name="transaction"></transaction-details>
                <login-page name="login"></login-page>
                <payment-page name="payments"></payment-page>
                <user-home name="home"></user-home>
        ...
        <iron-media-query query="min-width: 600px" query-matches="{{wideLayout}}"></iron-media-query>
         ...
         _pageChanged(page) {
          ...
          switch(page){
            case 'mortgage': import('./mortgage-info.js')
              break;
            case 'transaction': import('./transaction-details.js')
              break;
            case 'login': import('./login-page.js')
              break;
            case 'payments': import('./payment-page.js')
              break;
            case 'home': import('./user-home.js')
              break;
